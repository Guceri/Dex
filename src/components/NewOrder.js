  ...
  return(
    <Tabs defaultActiveKey="buy" className="bg-dark text-white h5 " variant ="pill"> 
      <Tab eventKey="buy" title="Buy" className="bg-dark">
          ...
          <button type="submit" className="btn btn-primary btn-sm btn-block">PLACE BUY ORDER</button>
      ...
      <Tab eventKey="sell" title="Sell" className="bg-dark">
        ...
        <button type="submit" className="btn btn-primary btn-sm btn-block">PLACE SELL ORDER</button>
