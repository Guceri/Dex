//this file is designed to handle all of our blockchain interactions (web3)
...
export const loadWeb3 = (dispatch) => {
  ...
  //action is dispatched to reducer here. web3Loaded action takes the conneciton input
